---
layout: homepage
title: Governance of Data Institutions
permalink: /research/data-institutions/
---

<!-- TODO: Expand this landing page with more detailed content. Consider adding case study visualisations, interactive elements, or policy framework diagrams. This is initial scaffolding. -->
...
Data Institutions represent a diverse family of organisational forms united by two core principles:

1. **Delegated Fiduciary Responsibility:** Data-generating individuals and communities delegate responsibility for stewarding their data to a management function
2. **Collective or Commons-Based Governance:** DIs engage with data users on the community's behalf through democratic mechanisms
...
Examples include data trusts, data collaboratives, data intermediaries, data spaces, and data altruism organisations.

---

## The Case for Data Institutions in ML

ML datasets present a strategic policy surface within otherwise opaque ML value chains—and DIs present an ideal template for their governance.

### Two-Fold Public Value Creation

1. **Democratic Voice:** Integrating diverse voices into foundational value-encoding and direction-setting processes at the heart of AI development
2. **Service Platform:** Institutional platforms for contextually-appropriate downstream service offerings—quality assurance, semantic interoperability, responsible consent management, and financial sustainability
...
- **Commons-based approaches** can address the paradox of openness that remains unaddressed by current AI policy debates
...
For proofs-of-concept, see work from the Data Trusts Initiative, GovLab's Data Collaboratives, and the Open Data Institute's work on bottom-up data institutions.
